...
import type { OpResult as _OpResult, UserRole as _UserRole, WasmEntry as _WasmEntry } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addAdmin(arg0: Principal): Promise<OpResult> {
        if (this.processError) {
            try {
                const result = await this.actor.addAdmin(arg0);
                return from_candid_OpResult_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getWasm(): Promise<WasmEntry | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getWasm();
    ...
    async removeAdmin(arg0: Principal): Promise<OpResult> {
        if (this.processError) {
            try {
    ...
    async storeWasm(arg0: Uint8Array): Promise<OpResult> {
        if (this.processError) {
            try {
                const result = await this.actor.storeWasm(arg0);
                return from_candid_OpResult_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_OpResult_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OpResult): OpResult {
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WasmEntry]): WasmEntry | null {
    return value.length === 0 ? null : value[0];
}
